<div class="header-content-1 d-flex align-items-center">
    ...
    <div class="header-content-item header-alert">
        <button class="btn btn-default text-white pt-0">
...
</div><?php /**PATH /var/www/html/PointDEVENTe/inventory/resources/views/components/util/head-bar-action/bar.blade.php ENDPATH**/ ?>