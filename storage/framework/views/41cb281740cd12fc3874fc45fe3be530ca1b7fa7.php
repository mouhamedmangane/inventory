<div id="head-bar-action-user" class="head-bar-action-content-item">
    ...
    <div class="d-flex justify-content-center ">
        <div class="" style="position: relative;">
            <img src="<?php echo e(URL::asset('images/profig.jpg')); ?>" alt="" width="80px" height="80px"  class="rounded-circle">
    ...
    <div class="my-1 mt-2">
        <div class="text-center  font-weight-bold "><?php echo e($user->name); ?></div>
        <div class="text-center "><?php echo e($user->login); ?></div>
...
</div><?php /**PATH C:\noppal_workspace\laravel_project\inventory\resources\views/components/util/head-bar-action/user-content.blade.php ENDPATH**/ ?>