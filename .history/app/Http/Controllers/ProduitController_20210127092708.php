...
class ProduitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //     if($request->prixVenteMin){
        //         $validator->errors()->add(
        //             'libelle', 'Something is wrong with this libelle!'
        //         );
        //     }
        // });
        ...
        if ($validator->fails()) {
            return response()->json([
                "status"=>false,
                "message"=>"Certains valeurs du formulaire sont mal saisi ou sont incorrects:".(string)$request->all(),
