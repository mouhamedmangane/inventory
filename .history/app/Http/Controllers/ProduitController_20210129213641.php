        ...
        $message='Test';
         ...
         $json= DataTables::of($produits)
            ...
            ->addColumn('categorie',function($produit){                
                return 'Catégore';//$produit->groupe_produit->groupe_name?$produit->groupe_produit->groupe_name:'Néant';
            })
            ->addColumn('image',function($produit){                
                return 'Image';//$produit->groupe_produit->groupe_name?$produit->groupe_produit->groupe_name:'Néant';
            })
