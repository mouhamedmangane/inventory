    ...
    protected $achatable=false;
     ...
     public function returnData(){
        ...
        if($data="non_archived"){
         ...
         $json = DataTablesDataTables::of($produits)
            ...
            ->addColumn('produit',function($produit){     
                ...
                return "<a href=".asset("vente/33/view")."><img src=".asset($srcImag)."
                        width='40px'
                        height='40px'
                        class='rounded-circle' 
                        >
                        <span class='ml-2 '> ".$produit->libelle."</span></a>";
            })
            ...
            ->rawColumns(['produit','code','categorie','seuilstock',"prixAchat",'prixVente','rI','fournisseur'])
            ->with('status',$status)
