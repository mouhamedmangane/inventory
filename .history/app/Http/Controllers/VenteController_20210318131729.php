...
class VenteController extends Controller
{
    ...
    public function returnVentes(){
        ...
        $dataTable = DataTables::of($ventes)
            ->addColumn('produit',function($ventes){                
                $srcImag='images/produits/'.$ventes->img;
                if(!is_file($srcImag))    
                ...
                return "<img src=".asset($srcImag)."
                        ...
                        >
                        <span class='ml-2 '> ".$ventes->libelle."</span>";
            }) 
            ->addColumn('client',function($ventes){
                return "Ass";
            })  
            ->addColumn('montantRestant',function($ventes){
                return "Ass";
            })  
            ->addColumn('produits',function($ventes){
                return "Ass";
            })   
            ->addColumn('statut',function($ventes){
                return "Ass";
            }) 
