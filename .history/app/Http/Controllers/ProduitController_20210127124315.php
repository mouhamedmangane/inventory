...
class ProduitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $achat=false;
        $vendre=false;
        //verification si le produit est achetable ou vendable => si les champs prix_vente et prix d'achat seront saisies obligatoirement
     ...
     dd($validator->errors());
        ...
        $produit->groupe_name=GroupeProduit::find($request->categorie)->id;
        ...
        $produit->qteStock=$request->qteStock;
        $produit->qteSeuil=$request->qteSeuil;
        $produit->prix_vente_min=$request->prixVenteMin;
        $produit->prix_vente_max=$request->prixVenteMax;
        $produit->prix_achat_min=$request->prixAchatMin;
        $produit->prix_achat_max=$request->prixAchatMax;
        if($produit->save()){
            return response()->json([
                "status"=>true,
