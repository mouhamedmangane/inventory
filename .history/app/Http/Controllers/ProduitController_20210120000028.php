        ...
        $message='Test';
         ...
         $json= DataTables::of($produits)
            ->addColumn('status',function($produit){
                $statu=new Simple('dd','bagde-success');
                return View::make('x-generic.badge.simple')->with("name","test")->with("classStyle",'badge-success');
                // return new Simple('','bagde-success')->render();
            })
