        ...
        $validator->after(function ($validator) use ($request,$vendre,$achat){
            ...
            if($achat){
                if($request->prix_achat_min==null){
                    $validator->errors()->add('prix_achat_min','Le prix de achat n\'est pas renseignée');
                }
               else if($request->prix_achat_max!=null && $request->prix_achat_min >= $request->prix_achat_max){
                    $validator->errors()->add('prix_achat_max','Le prix de achat maximal doit être supérieur au prix de achat Minimal');
              }
            }
        });
