        ...
        $message='Test';
         ...
         $json= DataTables::of($produits)
            ...
            ->addColumn('categorie',function($produit){                
                $categorie = (object) GroupeProduit::find($produit->groupe_produit_id);
                $categorie->groupe_name;//$produit->groupe_produit->groupe_name?$produit->groupe_produit->groupe_name:'Néant';
            })
