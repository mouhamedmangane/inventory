...
class VoirVente extends Component
{
    ...
    public function titre(){
        ...
        if($this->vente->complet){
            $data[3]= (object)  ['name'=>'Qté Reçue','propertyName'=>'quantiteRecu'];
        }
    ...
    public function ventes(){
        ...
        ->addColumn('quantiteRecu',function($ligneVentes){      
                return "
                <div class='d-flex justify-content-center w-100' style='font-size:22px;'><span class='badge badge-success '>".$ligneVentes->quantiteDemande."</span>";
                })
