...
class VoirVente extends Component
{
    ...
    public function ventes(){
        ...
        ->addColumn('recu_demande',function($ligneVentes){      
                return "<div class='d-flex <i class="fa fa-align-justify" aria-hidden="true"></i>'>
                            <span class='badge badge-success'>".$ligneVentes->quantiteRecu."</span>  / 
                            <span class='badge badge-primary'>".$ligneVentes->quantiteDemande."</span>
                        </div>" ;
                }) 
