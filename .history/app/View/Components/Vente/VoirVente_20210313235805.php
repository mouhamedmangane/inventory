    ...
    public function ventes(){
        ...
        ->addColumn('recu_demande',function($ligneVentes){      
                return "<div class='d-flex justify-content-center'>
                            <span class='badge badge-success font-weight-bold w-100'>".$ligneVentes->quantiteRecu."  <span class='font-weight-bold p-1'> / </span> 
                            <span class='badge badge-light w-50'>".$ligneVentes->quantiteDemande."</span></span>  
