...
class VoirVente extends Component
{
    ...
    public function ventes(){
        ...
        ->addColumn('recu_demande',function($ligneVentes){      
                return "<div class='d-flex justify-content-center w-100' style='font-size:25px;'>
                            <span class='border border-success badge badge-success p-0 pl-2'>".$ligneVentes->quantiteRecu."  
                                
                                <span class='badge badge-light '> / ".$ligneVentes->quantiteDemande."</span>
                            </span>  
