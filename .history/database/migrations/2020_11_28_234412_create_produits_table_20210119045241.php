...
class CreateProduitsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('produits', function (Blueprint $table) {
            ...
            $table->double('prixVenteMin', 10, 2);
            $table->double('prixAchatMin', 10, 2); 
            $table->double('prixVenteMax', 10, 2);
            $table->double('prixAchatMax', 10, 2); 
            $table->boolean('archived')->nullable()->default(true);
