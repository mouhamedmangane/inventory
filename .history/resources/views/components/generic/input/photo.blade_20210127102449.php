...
<div class="d-flex align-items-center">
    <div style="width: {{ $x }}px; height:{{ $y }}px;background-size:{{ $x-20 }}px {{ $y-20 }}px;"
         ...
         <img src="{{ $url }}"  
              ...
              style="@empty ($url) display:none;@endif">
        ...
        <div class="input-img-action" >
                <input type="file" 
                       ...
                       id={{ $id }} 
                       style="display: none;">
                <button class="btn btn-sm btn-primary" typpe="type" style="padding:2px 5px;" id="{{ $id }}-edit" >
                    <i class="material-icons md-14" >edit</i>
                </button>
                <button class="btn btn-sm btn-danger ml-1" typpe="type" style="padding:2px 5px;" id="{{ $id }}-sup">
