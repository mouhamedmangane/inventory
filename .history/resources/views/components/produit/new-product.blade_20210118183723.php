            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <x-generic.forms.form-table render="voir">
                        ...
                        <x-generic.forms.form-table-text name="rI" labelText="Quantité Stock " required="true" placeholder="Comment vous reconnez votre produit en interne" id="libelle"/> 
                        <x-generic.forms.form-table-text name="rI" labelText="Quantité Seuil " required="true" placeholder="code du produit" id="libelle"/> 
                    </x-generic.forms.form-table>
