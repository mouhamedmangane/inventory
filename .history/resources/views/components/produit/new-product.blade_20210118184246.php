    ...
    <x-generic.navs-tabs.content id="myTabContent" class="px-4 py-3" >
        ...
        <x-generic.navs-tabs.pane id="general" active="true" >
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <x-generic.forms.form-table render="voir">
                        <x-generic.forms.form-table-text {{ $attributes['type'] }} name="qteStock" labelText="Quantité Stock " required="true" placeholder="quantité initial du produit" id="qteStock"/> 
