...
<form action="{{URL::route('produit.save')}}" id="addProduct" class=" mt-0" method="post">
    @csrf
    ...
    <x-generic.navs-tabs.content id="myTabContent" class="px-4 py-3" >
        ...
        <x-generic.navs-tabs.pane id="general" active="true" >
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <x-generic.forms.form-table render="voir">
                        <x-generic.forms.form-table-text name="rI" labelText="Référence Interne "  placeholder="Comment vous reconnez votre produit en interne" id="libelle"/> 
                        <x-generic.forms.form-table-text name="code" labelText="Code " required="true" placeholder="code du produit" id="libelle"/> 
                    </x-generic.forms.form-table>
                        
                </div> 
                <div class="col-md-6 col-sm-12">
                    <x-generic.forms.form-table render="voir">
                        <x-generic.forms.form-table-text typpe="number" name="qteStock" labelText="Quantité Stock " placeholder="quantité initial du produit" id="qteStock"/> 
                        <x-generic.forms.form-table-text typpe="number" name="qteSeuil" labelText="Quantité Seuil "  placeholder="quantité minimal en stock" id="qteSeuil"/> 
                    </x-generic.forms.form-table>                        
                </div>
         ...
         <x-generic.navs-tabs.pane id="vente" >
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <x-generic.forms.form-table> 
                        <x-generic.forms.form-table-interval  name="prix_vente" required="true" labelText="Prix de Vente" id="prix_vente" type="fixe" minValue="1" maxValue="3"/> 
                    </x-generic.forms.form-table>
                </div>     
