    ...
    <div class="d-flex align-items-center justify-content-between pl-3 mt-1 w-100 flex-wrap-sm" style="overflow-x: hidden;">
        <div class="d-flex align-items-center my-2 n-col-sm-12">
            ...
            <x-generic.links.select-link contentCible="my-main" value="test1" class="mx-2"
                :dt="['/produit/data/'=>'Mes Produits','/produit/list/nonarchived'=>'Produit Composés','/produit/list/archived'=>'Produits Archivés','/test2'=>'Produit  Vendable']" />
...
@section('ly-main-content')
    <div class=" pt-2">
        <x-generic.data-table.simple name="myDataTable" url="{{ url('/produit/data/'.$attributes['$data'].'') }}" :columns="$columns()"
