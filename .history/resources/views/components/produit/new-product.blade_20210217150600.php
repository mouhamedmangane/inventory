    ...
    <x-generic.navs-tabs.content id="myTabContent" class="px-4 py-3" >        
        ...
        <x-generic.navs-tabs.pane id="achat" >
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <x-generic.forms.form-table> 
                        <x-generic.forms.form-table-interval labelText="Produit" name="prix_achat" id="Ajustement"/> 
                    </x-generic.forms.form-table>
                </div>     
            </div>      
        </x-generic.navs-tabs.pane>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <x-generic.forms.form-table> 
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <x-generic.forms.form-table-text  name="prix_achat" labelText="Prix d'achat" id="prix_achat" type="fixe" minValue="1" maxValue="3"/> 
                            </table>
                            </div>     
                        </div>
                    </x-generic.forms.form-table>
