...
<div class="d-flex justify-content-end">
    <div id="monnaie" class="bg-warning  px-3 py-2" style="font-size:24px;"> 
        Monnaie  : <label id=""for="">15 000 </label>FCFA
    </div>
    <div id="mtotal" class="bg-success px-3 py-2 ml-2" style="font-size:24px;"> 
        Total : 350 000 FCFA
    </div>
