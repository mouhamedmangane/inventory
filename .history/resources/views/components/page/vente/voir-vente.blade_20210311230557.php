...
<div class="d-flex align-items-center justify-content-between px-4 mt-1">
    ...
    <div class="">
        <x-generic.infos.info-list>
            <x-generic.infos.info-item title="Numero Vente" value="V001C0" icon="trending_down" />
            <x-generic.infos.info-item title="Montant Total" value="24 500" icon="equalizer" />
            <x-generic.infos.info-item title="Montant Restant" value="24 500" icon="equalizer" />
        </x-generic.infos.info-list>
    </div>
</div>
@endsection
