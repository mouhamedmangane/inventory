...
<div class="d-flex align-items-center justify-content-between px-4 mt-1">
    ...
    <div class="">
        <x-generic.infos.info-list>
            <x-generic.infos.info-item title="Somme à payer" value="{{$vente->montantTotal}} FCFA" icon="payments" typeIcon="material-icons-outlined" />
     ...
     {{-- @elseif($condition) vente complet livraison ou paiement incomplet --}}
            ...
            @else
                 <x-generic.infos.info-item title="Statut Vente" value="INCOMPLETE" icon="assignment_tu -rned_in" couleur="danger" />
            @endif
