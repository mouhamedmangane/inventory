...
<div class="d-flex align-items-center justify-content-between px-4 mt-1">
    ...
    <div class="">
        <x-generic.infos.info-list>
            <x-generic.infos.info-item title="Somme à payer" value="{{$vente->montantTotal - $->ligne_payement_ventes->sum('montant')}} FCFA" icon="payments" typeIcon="material-icons-outlined" />
