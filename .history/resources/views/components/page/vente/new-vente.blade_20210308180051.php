...
<div class="d-flex justify-content-end">
    <div id="" class="px-3 py-2" style="border-width: thick;border-style:inset; border-color: #276738;border-radius: 6px; font-size:24px;">
        Monnaie  : <label id="monnaie" for="">15 000 </label>FCFA
    </div>
    <div id="" class="border-right border-success px-3 py-2 ml-2" style="font-size:24px;"> 
