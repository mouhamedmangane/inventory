...
<div class="d-flex align-items-center justify-content-between px-4 mt-1">
    <div class="d-flex align-items-center">
        ...
        @props(['NumVente']=>$this->ligne_payement_ventes->sum('montant');)
         <x-generic.links.select-link contentCible="my-main" value="/vente/allventes" :dt="['vente/'=>'Ventes','/vente/allventes'=>'Ventes / N° : {{$vente->numeroVente}}']" />
    ...
    <div class="">
     ...
     {{-- @elseif($condition) vente complet livraison ou paiement incomplet --}}
...
@section('ly-main-bot')
       <div class="col-md-6">
             {{$vente->ligne_ventes->count()}} Variante de produit(s) achetée(s)
