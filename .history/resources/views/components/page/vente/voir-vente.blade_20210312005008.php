...
<div class="d-flex align-items-center justify-content-between px-4 mt-1">
    <div class="d-flex align-items-center">
        <div  class="rounded-circle border  text-align center d-flex align-items-center justify-content-center" 
         ...
         <x-generic.links.select-link contentCible="my-main" value="/vente/allventes" :dt="['Ventes'=>'/vente/allventes'=>'Ventes / N° : V0000C0']" />
        00
    </div>
    <div class="">
        <x-generic.infos.info-list>
            ...
            <x-generic.infos.info-item title="Somme à payer" value="5 500 FCFA" icon="equalizer" />
        </x-generic.infos.info-list>
    </div>
</div>
@endsection
