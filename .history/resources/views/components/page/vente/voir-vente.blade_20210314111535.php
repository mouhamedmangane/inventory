...
<div class="d-flex align-items-center justify-content-between px-4 mt-1">
    <div class="d-flex align-items-center">
        ...
        @props(['numVente']=>"Ventes / N°: ".$vente->numeroVente)
         <x-generic.links.select-link contentCible="my-main" value="/vente/allventes" :dt="['vente/'=>'Ventes','/vente/allventes'=>'Ventes / N° : $numVente ']" />
