...
<div class="d-flex align-items-center justify-content-between px-4 mt-1">
    ...
    <div class="">
        <x-generic.infos.info-list>
            ...
            @elseif(!$vente->payement_complet()){{--  ou livraison incomplete --}}                    <x-generic.infos.info-item title="Statut Vente" value="INCOMPLETE" icon="assignment_turned_in" couleur="warning" /> 
            @else
