                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-12 d-flex justify-content-right align-items-right">
                                <x-generic.forms.form-table> 
                                    ...
                                    <x-generic.forms.form-table-text name="mrecu" labelText="Montant TOTAL"  placeholder="Nom Produit" id="nom"/>
                                    <x-generic.forms.form-table-text name="Monnaie" labelText="Montant TOTAL"  placeholder="Nom Produit" id="nom" style="border: red"/>
