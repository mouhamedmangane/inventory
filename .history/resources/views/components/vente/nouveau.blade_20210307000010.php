    ...
    <div class="d-flex justify-content-first flex-unwrap" >
            ...
            <div class="col-md-4 col-sm-6 p-2 mt-1 ">
                <x-generic.forms.form-table >
                 ...
                 value=""  />  
                 <x-generic.forms.form-table-label labelText="Tel : 77 383 42 65" name="tel"  placeholder="Nom du client" required="false"  id="tel"
                 value=""  />  
                </x-generic.forms.form-table >
            </div>
...
@once
    ...
    <script>
      $(function(){
            ...
            $('#client').addEventInput('change',function(e){
              console,lo('#client').value
