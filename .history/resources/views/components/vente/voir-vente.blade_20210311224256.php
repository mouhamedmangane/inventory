...
<x-generic.navs-tabs.nav id="myTab" class="px-2  ">
    ...
    <x-generic.navs-tabs.item text="Paiement" idPane="vente" id="vente-tab" />
    <x-generic.navs-tabs.item text="L" idPane="achat" id="achat-tab"  />
    <x-generic.navs-tabs.item text="Détails Vente" idPane="composants" id="composants-tab"  />
