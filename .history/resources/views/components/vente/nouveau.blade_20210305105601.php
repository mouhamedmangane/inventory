                ...
                <x-generic.forms.form-table >
                    ...
                    :dt="$clients" value="" />
                        ...
                        <div class="row">
                            ...
                            <div class="row">    
                                <div class="col-2"></div>                           
                                <div class="col-md-4 col-sm-12 d-flex justify-content-right align-items-right">
                                    <x-generic.forms.form-table> 
                                ...
                                </div>  <div class="col-md-4 col-sm-12 d-flex justify-content-right align-items-right">
                                    <x-generic.forms.form-table> 
                                        <x-generic.forms.form-table-text name="mrecu" labelText="Montant Reçu"  placeholder="Nom Produit" id="nom"/>
                                    </x-generic.forms.form-table>
                           </div>
                            </div>  <div class="col-md-6 col-sm-12 d-flex justify-content-right align-items-right">
                                <x-generic.forms.form-table> 
