...
<x-generic.navs-tabs.nav id="myTab" class="px-2  ">
    <x-generic.navs-tabs.item text="Information Vente" idPane="general"  id="general-tab"  classLink="ml-3" />
    <x-generic.navs-tabs.item text="Paiement" idPane="paiement" id="paiement-tab" active="true" />
