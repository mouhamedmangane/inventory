<x-generic.modal.simple id="modal_profil_form" titre="Modification Profil" :url="url('profil_save')" idForm="form_profil_form" class="">

    <div class="">
        <x-generic.forms.form-table class="form-table-none">
            <x-generic.forms.form-table-text name="old_pwd" labelText="Ancien Mot de passe" disposition="block"
