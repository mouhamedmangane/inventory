...
@section('ly-toolbar')
    <x-generic.tool-bar.bar >
        <x-generic.tool-bar.prev-button id="prev_tb"  url="/produit/{{$produit->id}}"  />
...
<div class="d-flex align-items-center justify-content-between px-4 mt-1">
    <div class="d-flex align-items-center">
        <div class="rounded-circle border  text-align center d-flex align-items-center justify-content-center"
         ...
         <x-generic.links.select-link contentCible="my-main" value="test1" :dt="['/produit/'.$produit->id.'/edit'=>'Modification Produit : '.$produit->libelle,]" />
    </div>
...
@section('ly-main-content')
    <x-produit.util.modifier :produit="$produit"  />
@endsection
