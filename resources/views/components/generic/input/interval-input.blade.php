...
<div>
    <div>
        <x-generic.input.radios name="{{ $name }}__radio"
                            :dt="$radioData"
                            :value="$type"
                            id="{{ $idd}}__radio"
                            />
    ...
    <div class="d-flex align-items-center" >
        <div id="{{ $idd }}__min__content" class="mt-2 flex-grow-1">
            <x-generic.input.text :name="$name.'_min'" type="number"
                                  id="{{ $idd }}__min"
        ...
        <div id="{{ $idd }}__max__content"
            ...
            <x-generic.input.text :name="$name.'_max'" type="number" id="{{ $idd }}__max"  placeholder="max" :value="$maxValue" />
        </div>
