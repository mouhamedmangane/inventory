...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("page.param-compte.role.liste-role",compact('roles'));
    }
        ...
        if($validator->fails()){
            ...
            try {
                ...
                foreach($request->objet as $objet_id){
                    ...
                    if($request->id!=0 && RoleObjet::where('role_id',$role->id)->where('objet_id',$objet_id)->exists()){
                        $roleObjet=RoleObjet::where('role_id',$role->id)->where('objet_id',$objet_id)->first();
                    }
                    else{
